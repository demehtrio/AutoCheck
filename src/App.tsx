                ...
                {currentTab < tabs.length - 1 ? (
                  ...
                  <div className="flex-[3] flex gap-2">
                    <button 
                      ...
                      disabled={submitting}
                      className="flex-1 py-4 rounded-2xl bg-white border-2 border-slate-200 text-slate-700 font-bold shadow-sm active:scale-95 transition-all flex items-center justify-center gap-2"
                    >
                      {submitting ? (
